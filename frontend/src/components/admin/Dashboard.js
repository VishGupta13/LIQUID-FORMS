          ...
          <div className="col-lg-6">
            <div className="card">
              <div className="card-body">
                ...
                <div
                  className="alert alert-light border-light alert-dismissible fade show"
                  role="alert"
                >
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div
                  className="alert border-primary alert-dismissible fade show"
                  role="alert"
                >
                ...
                <div
                  className="alert border-secondary alert-dismissible fade show"
                  role="alert"
                >
                ...
                <div
                  className="alert border-success alert-dismissible fade show"
                  role="alert"
                >
                ...
                <div
                  className="alert border-danger alert-dismissible fade show"
                  role="alert"
                >
                ...
                <div
                  className="alert border-warning alert-dismissible fade show"
                  role="alert"
                >
                ...
                <div
                  className="alert border-info alert-dismissible fade show"
                  role="alert"
                >
                ...
                <div
                  className="alert border-light alert-dismissible fade show"
                  role="alert"
                >
          ...
          <div className="col-lg-6">
            <div className="card">
              <div className="card-body">
                ...
                <div
                  className="alert alert-secondary bg-secondary text-light border-0 alert-dismissible fade show"
                  role="alert"
                >
                ...
                <div
                  className="alert alert-warning bg-warning border-0 alert-dismissible fade show"
                  role="alert"
                >
                ...
                <div
                  className="alert alert-info bg-info border-0 alert-dismissible fade show"
                  role="alert"
                >
                ...
                <div
                  className="alert alert-light bg-light border-0 alert-dismissible fade show"
                  role="alert"
                >
                ...
                <div
                  className="alert alert-dark bg-dark text-light border-0 alert-dismissible fade show"
                  role="alert"
                >
            ...
            <div className="card">
              <div className="card-body">
                ...
                >
                  ...
                  <p>
                    Et suscipit deserunt earum itaque dignissimos recusandae
                    dolorem qui. Molestiae rerum perferendis laborum. Occaecati
                    illo at laboriosam rem molestiae sint.
                  </p>
                  <hr />
                  <p className="mb-0">
                    Temporibus quis et qui aspernatur laboriosam sit eveniet qui
                    sunt.
                  </p>
                  <button
                    type="button"
